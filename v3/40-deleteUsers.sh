...
$DRY ./db-connect${role}.sh 'drop role if exists psqltestro'
$DRY ./db-connect${role}.sh 'drop role if exists psqltestrw'
$DRY ./db-connect${role}.sh 'drop role if exists psqltestrwd'
$DRY ./db-connect${role}.sh 'drop role if exists psqltestrwdt'
